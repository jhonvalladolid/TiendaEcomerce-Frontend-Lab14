            ...
            <div className="row">
                <div className="col-md-6 col-lg-3 pb-5">
                    <div className="h-100 py-5 services-icon-wap shadow">
                        ...
                        <h2 className="h5 mt-4 text-center">Servicios de Entrega</h2>
                    </div>
                </div>
                <div className="col-md-6 col-lg-3 pb-5">
                    <div className="h-100 py-5 services-icon-wap shadow">
                        <div className="h1 text-success text-center"><i className="fas fa-exchange-alt"></i></div>
                        <h2 className="h5 mt-4 text-center">Envío y Devoluciones</h2>
                    </div>
                </div>
                <div className="col-md-6 col-lg-3 pb-5">
                    <div className="h-100 py-5 services-icon-wap shadow">
                ...
                <div className="col-md-6 col-lg-3 pb-5">
                    <div className="h-100 py-5 services-icon-wap shadow">
                        ...
                        <h2 className="h5 mt-4 text-center">Servicio 24 Horas</h2>
                    </div>
                </div>
            </div>
        </section>
